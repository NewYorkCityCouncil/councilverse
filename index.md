...
helps convert images to raw HTML. This is useful for adding extra
graphics to any HTML element in visualizations.
[`gt_table()`](https://newyorkcitycouncil.github.io/councilverse/reference/gt_table.md)
similarly converts `gt` outputs to raw HTML.
...
creates file names using accepted guidelines detailed in the function’s
documentation.
...
loads in shapefiles that come originally as zip files.
