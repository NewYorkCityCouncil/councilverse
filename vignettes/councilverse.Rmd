...
# borough, community, councildist, neighborhood, precinct, schooldist geographies are available
...
`councilPopup()` -- Wraps input in a `<div>` and sets Council fonts for body and headers
